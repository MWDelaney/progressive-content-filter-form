...
/**
 * Renamed and modified from https://github.com/tommcfarlin/page-template-example
 */
 ...
 class PageTemplate {
 	...
 	private function __construct() {
		...
		if ( version_compare( floatval($GLOBALS['wp_version']), '4.7', '<' ) ) { // 4.6 and older
 		...
 		$this->templates = array(
 			'template-questions.php'     => __( 'Progressive Content Filter', $this->plugin_slug ),
 		);
	...
	public function add_new_template( $posts_templates ) {
 	...
 	public function view_project_template( $template ) {
 		...
 		$file = plugin_dir_path( __FILE__ ) . '../views/templates/' . get_post_meta( $post->ID, '_wp_page_template', true );
